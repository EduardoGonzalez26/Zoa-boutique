...
export default function Footer() {
  ...
  const columnTitle = "flex items-baseline justify-between gap-3 pb-4 font-sans text-[10px] font-medium uppercase tracking-[0.25em] text-zoa-slate";
  const columnIndex = "font-sans text-[10px] tracking-[0.2em] text-zoa-slate-60 tabular";
  const columnLink = "block py-1.5 font-sans text-sm text-zoa-slate-60 transition-colors duration-200 hover:text-zoa-slate hover:underline underline-offset-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zoa-slate";
  ...
  return (
    <footer className="bg-zoa-surface text-zoa-slate">
      ...
      <div aria-hidden className="overflow-hidden px-5 pt-10 md:px-10 xl:px-20">
        <p className="select-none font-display text-[clamp(5rem,12vw,11rem)] font-normal leading-[0.8] tracking-[-0.02em] text-zoa-slate/[0.08]">
          ZOA
        </p>
      </div>
      ...
      <div className="container-zoa grid grid-cols-1 gap-10 py-14 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="space-y-4 sm:col-span-2 lg:col-span-1">
          ...
          <div className="flex items-center gap-2 font-sans text-sm text-zoa-slate-60">
            ...
            <a
              href="tel:5521068191"
              className="transition-colors duration-200 hover:text-zoa-slate hover:underline underline-offset-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zoa-slate"
            >
              5521068191
            </a>
          </div>
          ...
          <div className="flex items-center gap-4 pt-1">
            <a
              ...
              className="flex h-11 w-11 items-center justify-center text-zoa-slate transition-opacity duration-200 hover:opacity-60 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zoa-slate"
            >
        ...
        <div className="container-zoa flex flex-col items-center justify-between gap-3 py-6 md:flex-row">
          ...
          <p className="font-sans text-[11px] tracking-wide text-zoa-slate-60">
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-zoa-slate-60 transition-colors duration-200 hover:text-zoa-slate hover:underline underline-offset-4 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-zoa-slate"
            >
              webi.mx
            </a>
          </p>
